...
var scrape = function() {
  // Scrape the espnfc website
  return axios.get("http://www.espnfc.com").then(function(res) {
    ...
    $(".headlineStack").each(function(i, element) {
      ...
      var head = $(this)
        .children(".headlineStack__list")
        .text()
        .trim();

      // Grab the URL of the article
      var url = $(this)
        .children(".data-story-id")
        .children("a")
        .attr("href");
